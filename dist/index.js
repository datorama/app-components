...
`,Di=(e,t,n,r)=>{if(r){const a=0,i=(r-2*a)/e;if(1===e)return a+i/2-2;let o=a;for(let e=0;e<=t;e++)o+=e===t&&n?i/2:i;return o-2}return-999},Pi=e=>{const{rows:t,selectedIndex:n,amount:r,containerWidth:a}=e,i=Object(ft.size)(t),s=fi(i),l=bi(i),c=Ei(t[0].data,s[0]),u=Ei(t[i-1].data,s[i-1]),h=[l[0],40],p=[Di(r,n,!0,a),440],d=[Di(r,n,!0,a),20],f=[l[0]+mi[i-1],420];for(let o=0;o<=n;o++){const e=o===n?.5:1;h[0]+=c[o]*e,f[0]+=u[o]*e}return o.a.createElement(Li,{height:500,className:"tornado tornado-chart tornado-chart-arrows tornado-chart-arrows-container"},o.a.createElement(Ai,{id:"tornado-top-line",d:`M ${d[0]},${d[1]} l 0,20 L ${h[0]},${h[1]} l 0,20`,color:xi[n%6]}),o.a.createElement(zi,{id:"tornado-top-line-arrow",d:`M ${h[0]-8}, ${h[1]+20} l 16 0, l -8 8 z`,color:xi[n%6]}),o.a.createElement(Ai,{id:"tornado-bottom-line",d:`M ${f[0]},${f[1]} l 0,20 L ${p[0]},${p[1]} l 0,20`,color:xi[n%6]}),o.a.createElement(zi,{id:"tornado-bottom-line-arrow",d:`M ${p[0]-8}, ${p[1]+20} l 16 0, l -8 8 z`,color:xi[n%6]}))};Pi.propTypes={selectedIndex:Q.a.number,amount:Q.a.number,containerWidth:Q.a.number,rows:Q.a.arrayOf(Q.a.shape({id:Q.a.string,data:Q.a.arrayOf(Q.a.number),label:Q.a.string,totalValue:Q.a.number,totalPercentage:Q.a.string})),stats:Q.a.array};var Ri=Pi;const Li=l.a.svg`
  width: 100%;
  height: ${({height:e})=>`${e}px`};
  background: transparent;
  position: absolute;
...
`;function ro(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class ao extends o.a.Component{constructor(...e){super(...e),ro(this,"state",{selectedIndex:0}),ro(this,"selectIndex",e=>this.setState({selectedIndex:e}))}componentDidMount(){const{labels:e}=this.props.data,t=Math.floor(e.length/2);this.selectIndex(t)}topStrip(){const{data:e,topLabelRenderer:t=(()=>{})}=this.props,{selectedIndex:n}=this.state;return o.a.createElement(oo,{className:"tornado top-strip top-strip-container"},e.labels.map((e,r)=>o.a.createElement(so,{key:`label-${r}`,onClick:()=>this.selectIndex(r),className:"tornado top-strip top-strip-column"},t({text:e,pathColor:xi[r%5],isSelected:n===r}))))}bottomStrip(){const{data:e,bottomStatsRenderer:t=(()=>{})}=this.props,{selectedIndex:n}=this.state;return o.a.createElement(oo,{className:"tornado bottom-strip bottom-strip-container"},e.stats.map((e,r)=>o.a.createElement(lo,{className:"tornado bottom-strip bottom-strip-column",key:`stat-${r}`,onClick:()=>this.selectIndex(r),selected:n===r},t({stats:e,pathColor:xi[r],isSelected:n===r}))))}render(){const{data:e,className:t=""}=this.props,{selectedIndex:n}=this.state;return o.a.createElement(io,{className:t},this.topStrip(),o.a.createElement(Gi,{labels:e.labels,rows:e.rows,stats:e.stats,selectedIndex:n,selectIndex:this.selectIndex}),this.bottomStrip())}}ro(ao,"propTypes",{className:Q.a.string,data:Q.a.shape({labels:Q.a.arrayOf(Q.a.string),rows:Q.a.arrayOf(Q.a.shape({id:Q.a.string,data:Q.a.arrayOf(Q.a.number),label:Q.a.string,totalValue:Q.a.number,totalPercentage:Q.a.string})),stats:Q.a.array,topLabelRenderer:Q.a.func})});const io=l.a.div`
  width: 100%;
  min-height: 500px;
  display: flex;
  flex-direction: column;
