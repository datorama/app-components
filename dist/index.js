...
`,Sr=s.a.div`
  ...
  ${({disabled:e,theme:t})=>e&&l.css`
      color: ${Y(t.p300,35)};
    `};
`,zr=({children:e,open:t,className:n,position:r="BOTTOM",contentRenderer:a,withClose:i,toggleOpen:l})=>o.a.createElement(Ir,{className:n},e,o.a.createElement(Mr,{visible:t,className:"pop-menu",position:r},a(),i&&o.a.createElement(Fr,{onClick:l})));zr.propTypes={children:K.a.node,open:K.a.bool,className:K.a.string,contentRenderer:K.a.func,position:K.a.string,withClose:K.a.bool,toggleOpen:K.a.func};var Tr=zr;const Mr=s.a.div`
  position: absolute;
  padding: 6px 12px;
  border-radius: 3px;
  pointer-events: none;
