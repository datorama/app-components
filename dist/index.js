...
`,as=l.a.text`
  ...
  alignment-baseline: middle;
`,is=(e,t,n,r)=>{const a=(r-90)*Math.PI/180;return{x:e+n*Math.cos(a),y:t+n*Math.sin(a)}},os=(e,t,n,r,a)=>{const i=is(e,t,n,a),o=is(e,t,n,r),s=a-r<=180?"0":"1";return["M",i.x,i.y,"A",n,n,0,s,0,o.x,o.y].join(" ")},ss=e=>{const{className:t,min:n,max:r,labelRenderer:a,start:i,end:s,value:l}=e,c=st(),u=fa("elastic",2e3,0),p=(i-n)/(r-n),d=(s-n)/(r-n),h=i<=n?d:p,f=p<=n?s:i,m=is(200,200,135,275*u*((l-n)/(r-n))-135),g=is(200,200,170,275*u*h-135),b=200,v=260,x=b+.8*(m.x-b),y=v+.8*(m.y-v);return o.a.createElement(cs,{viewBox:"0 0 400 400",className:t},o.a.createElement(us,{d:os(200,200,110,0,275*u),stroke:c.p100,width:30,className:"thick-bg"}),o.a.createElement(us,{d:os(200,200,110,275*u*p,275*u*d),stroke:c.p200,width:30,className:"thick-value"}),o.a.createElement(us,{d:os(200,200,135,0,275*u),stroke:c.g100,width:10,className:"thin-bg"}),o.a.createElement(us,{d:os(200,200,135,275*u*p,275*u*d),stroke:c.g300,width:10,className:"thin-value"}),o.a.createElement(ps,{x:110,y:340,fill:c.p200,size:26,anchor:"end",className:"small-label"},a?a(n):n),o.a.createElement(ps,{x:290,y:340,fill:c.p200,size:26,anchor:"start",className:"small-label"},a?a(r):r),o.a.createElement(ps,{x:200,y:320,fill:c.p300,size:40,className:"large-label"},a?a(Math.round(u*l)):Math.round(u*l)),o.a.createElement(ps,{x:g.x,y:g.y,fill:c.p200,size:26,className:"small-label"},a?a(Math.round(u*f)):Math.round(u*f)),o.a.createElement(ds,{cx:m.x,cy:m.y,r:13,fill:c.g300,className:"circle"}),o.a.createElement(hs,{d:[`M ${b}, ${v}`,`L ${x}, ${y} z`].join(" "),fill:c.p400,className:"tick"}))};var ls=ss;ss.propTypes={start:K.a.number.isRequired,end:K.a.number.isRequired,min:K.a.number.isRequired,max:K.a.number.isRequired,value:K.a.number.isRequired,className:K.a.string,labelRenderer:K.a.func};const cs=l.a.svg`
  width: ${400}px;
  height: ${400}px;
  ${({theme:e})=>e.animation.fade};
`,us=l.a.path`
