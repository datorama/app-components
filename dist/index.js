...
`;var Bi=Pi;function Fi(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const qi=e=>({startDate:ji()(e.startDate),endDate:ji()(e.endDate)}),Ui=e=>({startDate:e.startDate.toDate(),endDate:e.endDate.toDate()});class Hi extends i.Component{constructor(e){super(e),Fi(this,"weekdays",[]),Fi(this,"datesRenderer",(e=0)=>{const{offset:t,today:n,selection:r,selecting:a,hoveredDate:i}=this.state,{firstDayOfWeek:s}=this.props,{startDate:l,endDate:c}=r,u=[],p=n.clone().startOf("month"),d=p.add(e+t,"month"),f=d.daysInMonth(),h=d.format("MMMM YYYY");this.weekdays.forEach((e,t)=>{u.push(o.a.createElement(to,{key:`date-${e}-${t}`,type:"title"},o.a.createElement(no,{type:"title"},e)))});for(let m=p.day();m>s;m--)u.push(o.a.createElement(to,{key:`date-placeholder-${m}`,disabled:!0}));for(let m=1;m<=f;m++){const e=d.clone().set("date",m);let t=e.isBetween(l,c,"day","[]");a&&e.isBetween(l,i,"day","[]")&&(t=!0);const r=e.isSame(l,"day"),s=e.isSame(c,"day"),p=l.isSame(c,"day")||!c;u.push(o.a.createElement(to,{key:`date-${m}`,onClick:()=>this.handleClick(e),onMouseEnter:()=>this.setHover(e),selected:t,sameDay:p,isStart:r,isEnd:s},o.a.createElement(no,{today:e.isSame(n,"day"),type:r||s?"edge":"normal"},m)))}return o.a.createElement(eo,{key:`month-${e}`},o.a.createElement(Ji,{onClick:this.selectMonth({startDate:n.clone().add(e+t,"month").startOf("month"),endDate:n.clone().add(e+t,"month").endOf("month")})},h),u)}),Fi(this,"setHover",e=>{const{selecting:t,tmpStart:n}=this.state;let r={};t&&(r=e.isBefore(n,"day")?{selection:{startDate:e,endDate:n}}:{selection:{startDate:n,endDate:e}}),this.setState(function(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},r=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),r.forEach(function(t){Fi(e,t,n[t])})}return e}({hoveredDate:e},r))}),Fi(this,"toggleOpen",()=>this.setState(e=>({open:!e.open}),()=>{this.state.open?this.setOffset():setTimeout(()=>{this.cancel()},300)})),Fi(this,"openPopup",()=>{const{open:e}=this.state;e||(this.setOffset(),this.setState({open:!0}))}),Fi(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.cancel()}),Fi(this,"setOffset",()=>{const{today:e,selection:t}=this.state,{startDate:n}=t;if(n){let t=n.clone().startOf("month").diff(e.clone().startOf("month"),"months");this.setState({offset:t})}}),Fi(this,"next",()=>this.setState(e=>({offset:e.offset+1}))),Fi(this,"prev",()=>this.setState(e=>({offset:e.offset-1}))),Fi(this,"apply",()=>{this.validateSelection()?this.setState({committedSelection:this.state.selection,committedSelectedPreset:this.state.selectedPreset,selecting:!1,open:!1},()=>this.props.onChange(Ui(this.state.committedSelection))):this.cancel()}),Fi(this,"cancel",()=>{this.setState({open:!1,selecting:!1,selection:this.state.committedSelection,selectedPreset:this.state.committedSelectedPreset})}),Fi(this,"handleClick",e=>{const{selecting:t,tmpStart:n}=this.state;t?e.isBefore(n,"day")?this.setState({selecting:!1,selection:{startDate:e,endDate:n}}):this.setState({selecting:!1,selection:{startDate:n,endDate:e}}):this.setState({selecting:!0,selection:{startDate:e,endDate:e},tmpStart:e,selectedPreset:[]})}),Fi(this,"selectMonth",e=>()=>this.setState({selection:e,selecting:!1,selectedPreset:[]})),Fi(this,"setPreset",e=>{this.setState({selecting:!1,selection:e[0].selection,selectedPreset:e},()=>{this.setOffset()})}),Fi(this,"onChangeDate",(e,t)=>{const{dateFormat:n}=this.props;ji()(t,n).isValid()&&this.setState(r=>{const{selection:a}=r;return{selection:Object(pt.set)([e],ji()(t,n),a)}})}),Fi(this,"validateSelection",()=>{const{selection:e}=this.state;return e.startDate.isSameOrBefore(e.endDate,"day")}),Fi(this,"onKeyDown",e=>{const{keyCode:t}=e;13===t?this.apply():27===t&&this.handleClickOut()}),Fi(this,"getPresetTitle",e=>{const{dateFormat:t}=this.props,{label:n,selection:r}=e,{startDate:a,endDate:i}=r;return`${n} (${a.format(t)} - ${i.format(t)})`}),Fi(this,"computeTooltipTitle",()=>{const{selectedPreset:e,selection:t}=this.state,{dateFormat:n}=this.props;if(!Object(pt.isEmpty)(e))return this.getPresetTitle(e[0]);const{startDate:r,endDate:a}=t;return`${r.format(n)} - ${a.format(n)}`}),ji.a.updateLocale("en",{week:{dow:this.props.firstDayOfWeek,doy:0===this.props.firstDayOfWeek?6:4}}),this.state={today:ji()(),offset:0,open:!1,selection:qi(this.props.dateRange),committedSelection:qi(this.props.dateRange),selecting:!1,selectedPreset:[],committedSelectedPreset:[],tmpStart:ji()(this.props.dateRange.startDate),hoveredDate:ji()()},this.weekdays=ji.a.weekdaysMin(!0)}render(){const{open:e,selectedPreset:t,selection:n}=this.state,{className:r,months:a,firstDayOfWeek:i,dateFormat:s,onMenuEnter:l,onMenuLeave:c}=this.props,u=[],{startDate:p,endDate:d}=n;for(let o=0;o<a;o++)u.push(this.datesRenderer(o));return o.a.createElement(Te,{onClick:this.handleClickOut},o.a.createElement(hn.Provider,{value:{onMenuEnter:l,onMenuLeave:c}},o.a.createElement(Zi,{title:this.computeTooltipTitle(),onClick:this.toggleOpen},o.a.createElement("div",null,o.a.createElement(Yi,null)),Object(pt.isEmpty)(t)?o.a.createElement(o.a.Fragment,null,o.a.createElement(Bi,{date:p,dateFormat:s,placeholder:"start date",onClick:this.openPopup,onKeyDown:this.onKeyDown,onChange:e=>this.onChangeDate("startDate",e)}),o.a.createElement(Gi,null,"-"),o.a.createElement(Bi,{date:d,dateFormat:s,placeholder:"end date",onClick:this.openPopup,onKeyDown:this.onKeyDown,onChange:e=>this.onChangeDate("endDate",e)})):o.a.createElement(Vi,null,this.getPresetTitle(t[0])),o.a.createElement("div",null,o.a.createElement(Ki,{rotation:e?"180deg":"0deg"}))),o.a.createElement(Xi,{visible:e,className:r,total:a},o.a.createElement(Mi,{onChange:this.setPreset,selectedPreset:t,firstDayOfWeek:i}),o.a.createElement(ao,{margin:"0"}),o.a.createElement(Qi,null,o.a.createElement(so,{onClick:this.prev},o.a.createElement(lo,{rotation:"-180deg"})),o.a.createElement(so,{onClick:this.next},o.a.createElement(lo,{rotation:"0deg"}))),o.a.createElement(ro,null,u),o.a.createElement(ao,null),o.a.createElement(io,null,o.a.createElement(oo,{onClick:this.cancel},"Cancel"),o.a.createElement(oo,{primary:!0,onClick:this.apply},"Apply")))))}}Fi(Hi,"propTypes",{onChange:K.a.func,onMenuEnter:K.a.func,onMenuLeave:K.a.func,className:K.a.string,months:K.a.number,dateRange:K.a.shape({startDate:K.a.instanceOf(Date),endDate:K.a.instanceOf(Date)}),firstDayOfWeek:K.a.number,dateFormat:K.a.string}),Fi(Hi,"defaultProps",{months:1,dateRange:{startDate:new Date,endDate:new Date},firstDayOfWeek:0,dateFormat:"MM-DD-YYYY",onChange:()=>{},onMenuEnter:()=>{},onMenuLeave:()=>{}});const Zi=l.a.div`
  width: 100%;
  padding: 4px 8px;
  box-sizing: border-box;
  border-radius: 4px;
