...
`;var Gu=({handleDrag:e,dragColor:t,padding:n,width:r,height:i,dragTranslation:s})=>a.a.createElement(Du,{onChange:e,initialTranslation:Object(o.useMemo)(()=>[0,s],[s]),minY:-1*(i-2*n),maxY:0},a.a.createElement(Fu,{x1:2*n-2,x2:r-2*n+2,y1:i-n+s,y2:i-n+s,color:t}),a.a.createElement(Wu,{x1:2*n-2,x2:r-2*n+2,y1:i-n+s,y2:i-n+s,color:t}),a.a.createElement(Nu,{color:t,d:[`M ${2*n-1}, ${i-n+s+4}`,"l 4, 4","l 4, -4","z"].join(" ")}),a.a.createElement(Nu,{color:t,d:[`M ${2*n-1}, ${i-n+s-4}`,"l 4, -4","l 4, 4","z"].join(" ")}),a.a.createElement(Nu,{color:t,d:[`M ${r-2*n-7}, ${i-n+s+4}`,"l 4, 4","l 4, -4","z"].join(" ")}),a.a.createElement(Nu,{color:t,d:[`M ${r-2*n-7}, ${i-n+s-4}`,"l 4, -4","l 4, 4","z"].join(" ")}));const Hu=l.a.text`
  font-size: 14px;
  font-weight: 600;
  fill: ${({theme:e,color:t})=>t||e.a400};
`,Bu=l.a.rect`
