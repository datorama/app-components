...
class DatepickerPresets extends Component {
  ...
  setPresets() {
    ...
    this.presetsMap = {
      ...
      prevWeek: {
        startDate: this.today.clone().subtract(1, 'week').startOf('week'),
        endDate: this.today.clone().subtract(1, 'week').endOf('week'),
      },
      prevMonth: {
        startDate: this.today.clone().subtract(1, 'month').startOf('month'),
        endDate: this.today.clone().subtract(1, 'month').endOf('month'),
      },
      prevYear: {
        startDate: this.today.clone().subtract(1, 'year').startOf('year'),
        endDate: this.today.clone().subtract(1, 'year').endOf('year'),
      },
      prevQuarter: {
        startDate: this.today.clone().subtract(1, 'quarter').startOf('quarter'),
        endDate: this.today.clone().subtract(1, 'quarter').endOf('quarter'),
      },
    };
