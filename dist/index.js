...
`;function on(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class sn extends o.a.Component{constructor(...e){super(...e),on(this,"state",{open:!1,searchTerm:"",localValues:this.props.values}),on(this,"checkString",(e,t)=>t.toString().toLowerCase().includes(e.toLowerCase())),on(this,"toggleOpen",()=>{const{keepOpen:e,inlineSearch:t}=this.props,{open:n}=this.state;e&&n||this.setState(e=>({open:!e.open,searchTerm:e.open?e.searchTerm:""}),()=>{const{open:e}=this.state,{onOpen:n,onClose:r}=this.props;e&&(window.addEventListener("keydown",this.handleKeyDown),n&&n()),e||(window.removeEventListener("keydown",this.handleKeyDown),t&&setTimeout(()=>{this.setState({searchTerm:""})},300),r&&r())})}),on(this,"handleKeyDown",({key:e})=>{switch(e){case"Escape":this.toggleOpen()}}),on(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.toggleOpen()}),on(this,"onSelect",e=>()=>{const{multi:t}=this.props,{localValues:n}=this.state;let r=[];r=t?Object(se.find)(t=>t.value===e.value,n)?n.filter(t=>t.value!==e.value):[...n,e]:[e],this.applyChanges(r)}),on(this,"selectAll",()=>{const{options:e}=this.props,{localValues:t}=this.state;let n=[];(!t.length||t.length>e.length)&&(n=[...e]),this.applyChanges(n)}),on(this,"onSearch",e=>this.setState({searchTerm:e.target.value})),on(this,"debouncedOnChange",Object(se.debounce)(this.props.debounce,e=>this.props.onChange(e)))}componentDidUpdate(e,t){this.state.localValues===t.localValues&&this.props.values!==e.values&&this.setState({localValues:this.props.values})}componentWillUnmount(){window.removeEventListener("keydown",this.handleKeyDown)}filterOptions(){const{searchTerm:e}=this.state,{searchBy:t,options:n,sortable:r,sortDirection:a,sortBy:i}=this.props;return(r?Object(se.orderBy)(a,i,n):n).filter(n=>t.some(t=>this.checkString(e,n[t])))}applyChanges(e){const{closeOnSelect:t,multi:n}=this.props;this.setState({localValues:e},()=>{this.debouncedOnChange(e),!n&&t&&this.toggleOpen()})}render(){const{options:e,className:t,disabled:n,searchable:r,placeholder:a,headerRenderer:i,optionRenderer:s,optionLabelRenderer:l,multi:c,placeholderRenderer:u,menuRenderer:p,loading:f,maxItems:h,searchPlaceholder:d,error:m,small:g,large:b,inlineSearch:v,maxTags:x}=this.props,{open:y,searchTerm:_,localValues:w}=this.state,E=this.filterOptions();return o.a.createElement(ze,{onClick:this.handleClickOut,className:t},o.a.createElement(ln,{disabled:n,className:t},!v&&o.a.createElement(yt,{open:y,placeholder:a,values:w,options:e,headerRenderer:i,toggleOpen:this.toggleOpen,placeholderRenderer:u,loading:f,error:m,small:g,large:b}),v&&o.a.createElement(Gt,{values:w,open:y,placeholder:a,toggleOpen:this.toggleOpen,error:m,small:g,large:b,onSearch:this.onSearch,value:_,maxTags:x,onSelect:this.onSelect,loading:f}),o.a.createElement(qt,{open:y,searchable:r,onSearch:this.onSearch,options:E,total:e.length,values:w,multi:c,selectAll:this.selectAll,optionRenderer:s,onSelect:this.onSelect,menuRenderer:p,searchTerm:_,maxItems:h,searchPlaceholder:d,optionLabelRenderer:l,small:g,large:b,inlineSearch:v})))}}on(sn,"propTypes",{className:G.a.string,options:vt,values:vt,onChange:G.a.func,placeholder:G.a.string,sortBy:G.a.string,sortable:G.a.bool,multi:G.a.bool,disabled:G.a.bool,searchable:G.a.bool,keepOpen:G.a.bool,searchBy:G.a.arrayOf(G.a.string),loading:G.a.bool,debounce:G.a.number,headerRenderer:G.a.func,optionRenderer:G.a.func,optionLabelRenderer:G.a.func,placeholderRenderer:G.a.func,menuRenderer:G.a.func,maxItems:G.a.number,closeOnSelect:G.a.bool,sortDirection:G.a.oneOf(["asc","desc"]),searchPlaceholder:G.a.string,error:G.a.bool,small:G.a.bool,large:G.a.bool,inlineSearch:G.a.bool,maxTags:G.a.number}),sn.defaultProps={maxItems:5,sortable:!0,multi:!1,searchable:!1,sortBy:"label",searchBy:["label"],sortDirection:"asc",closeOnSelect:!0,debounce:0,maxTags:999};const ln=l.a.div`
  ...
  * {
  ...
  ${({disabled:e})=>e&&s.css`
      ...
      opacity: 0.5;
    `};
`,cn=({label:e,color:t,percentage:n,disabled:r,className:a})=>o.a.createElement(hn,{className:a,disabled:r},e&&o.a.createElement(dn,{className:"label",disabled:r},e),o.a.createElement(pn,{className:"outer"},o.a.createElement(fn,{percentage:n,color:t,disabled:r,className:"inner"})));cn.propTypes={label:G.a.string,color:G.a.string,percentage:G.a.number.isRequired,disabled:G.a.bool,className:G.a.string};var un=cn;const pn=l.a.div`
  width: 100%;
  height: 4px;
  border-radius: 4px;
  background: ${({theme:e})=>e.p100};
