...
`,Li=a.a.createContext({onMenuEnter:ft.noop,onMenuLeave:ft.noop});function ji(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function Pi(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Ai=e=>{const{open:t,searchable:n,onSearch:r,options:i,values:o,multi:s,selectAll:l,optionRenderer:c,onSelect:u,searchTerm:h,total:d,maxItems:f,searchPlaceholder:p,optionLabelRenderer:m,small:g,large:v,inlineSearch:_,currentHoveredOptionValue:y,toggleFocus:x,onKeyDown:b,onKeyUp:w}=e;let C=400;return s&&(C+=5),n&&(C+=5),a.a.createElement(Li.Consumer,null,({onMenuEnter:e,onMenuLeave:S})=>a.a.createElement(Wi,{visible:t,className:"menu",maxheight:`${C}px`,onMouseEnter:e,onMouseLeave:S},!_&&n&&a.a.createElement(qt,{onChange:r,value:h,searchPlaceholder:p,small:g,large:v,toggleFocus:x,onKeyDown:b,onKeyUp:w}),a.a.createElement(Qt,{className:"menu-multi-header",options:i,values:o,multi:s,selectAll:l,total:d,onChange:r,value:h}),!d&&a.a.createElement(rn,{className:"menu-no-results"}),a.a.createElement(Mi,{options:i,values:o,optionRenderer:c,multi:s,handleClick:u,maxItems:f,searchable:n,optionLabelRenderer:m,small:g,large:v,inlineSearch:_,currentHoveredOptionValue:y})))},Di=e=>{const{menuRenderer:t}=e;return t?t(function(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{};t%2?ji(n,!0).forEach(function(t){Pi(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):ji(n).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}({},e,{menuRenderer:()=>a.a.createElement(Ai,e)})):a.a.createElement(Ai,e)};var Ni=Di;Di.propTypes={open:X.a.bool,searchable:X.a.bool,onSearch:X.a.func,onMenuEnter:X.a.func,onMenuLeave:X.a.func,options:Dt,values:Dt,multi:X.a.bool,selectAll:X.a.func,optionRenderer:X.a.func,onSelect:X.a.func,searchTerm:X.a.string,total:X.a.number,maxItems:X.a.number,searchPlaceholder:X.a.string,optionLabelRenderer:X.a.func,small:X.a.bool,large:X.a.bool,inlineSearch:X.a.bool,toggleFocus:X.a.func,onKeyDown:X.a.func,onKeyUp:X.a.func};const Wi=l.a.div`
  ...
  ${({visible:e})=>e&&s.css`
      ...
      transform: translateY(0);
    `};
`;function Fi(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Gi=ft.map.convert({cap:!1});class Hi extends o.Component{constructor(...e){super(...e),Fi(this,"handleRef",e=>{e&&(this.el=e)}),Fi(this,"handleClick",()=>{this.props.toggleOpen(),this.focus()}),Fi(this,"handleInput",e=>{const{open:t,toggleOpen:n}=this.props;t||n(),this.props.onSearch(e)})}componentDidUpdate(e){this.props.values!==e.values&&this.focus()}focus(){this.el&&this.el.focus()}render(){const{loading:e,small:t,onKeyDown:n,onKeyUp:r}=this.props,i=[];return Gi((e,n)=>{n<this.props.maxTags&&i.push(a.a.createElement(qi,{key:`small-tag-${e.value}`,title:e.label},a.a.createElement(Ki,{small:t},e.label),a.a.createElement(Zi,{onClick:()=>this.props.onSelect(e)})))},this.props.values),this.props.values.length>this.props.maxTags&&i.push(a.a.createElement(qi,{key:"extra-tags",type:"info"},a.a.createElement(Ki,{small:t},"+",this.props.values.length-this.props.maxTags))),a.a.createElement(Ui,{disabled:e,onClick:this.handleClick,error:this.props.error,small:this.props.small,large:this.props.large,className:"inline-container",open:this.props.open},a.a.createElement(Vi,null,i,a.a.createElement(Yi,{onChange:this.handleInput,value:this.props.value,placeholder:this.props.placeholder||"Search",ref:this.handleRef,small:this.props.small,onFocus:this.props.toggleFocus,onBlur:this.props.toggleFocus,onKeyDown:n,onKeyUp:r})),!e&&a.a.createElement(Xi,{rotation:this.props.open?"180deg":"0deg"}),e&&a.a.createElement(Qi,null))}}Fi(Hi,"propTypes",{values:Dt,placeholder:X.a.string,toggleOpen:X.a.func,error:X.a.bool,small:X.a.bool,large:X.a.bool,open:X.a.bool,value:X.a.string,onSearch:X.a.func,maxTags:X.a.number,onSelect:X.a.func,loading:X.a.bool,toggleFocus:X.a.func,onKeyDown:X.a.func,onKeyUp:X.a.func});var Bi=Hi;const Ui=l.a.div`
  cursor: pointer;
  width: 320px;
...
`,Qi=l()($t)`
  margin-right: 8px;
`;function Ji(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const eo=a.a.createContext(null);class to extends a.a.Component{constructor(...e){super(...e),Ji(this,"state",{open:!1,searchTerm:"",localValues:this.props.values,currentHoveredOptionValue:null,currentHoveredOptionIndex:0,inputFocused:!1}),Ji(this,"filteredOptions",[]),Ji(this,"checkString",(e,t)=>t.toString().toLowerCase().includes(e.toLowerCase())),Ji(this,"filterGroupedOptions",()=>{const{searchTerm:e}=this.state,{searchBy:t,options:n,sortable:r,sortDirection:i,sortBy:o}=this.props,a=Object(ft.map)(n=>{const r=n.options.filter(n=>t.some(t=>this.checkString(e,n[t])));return Object(ft.set)("options",r,n)},n);return r?this.sortGroupedOptions(a,o,i):a}),Ji(this,"sortGroupedOptions",(e,t,n)=>Object(ft.map)(e=>{const r=Object(ft.orderBy)([t],[n],e.options);return Object(ft.set)("options",r,e)},e)),Ji(this,"toggleOpen",()=>{const{keepOpen:e,inlineSearch:t}=this.props,{open:n}=this.state;e&&n||this.setState(e=>({open:!e.open,searchTerm:e.open?e.searchTerm:""}),()=>{const{open:e,currentHoveredOptionValue:n}=this.state,{onOpen:r,onClose:i}=this.props;if(e){window.addEventListener("keydown",this.handleKeyDown);const e=Ot(this.filteredOptions).findIndex(e=>e.value===n);this.setState({currentHoveredOptionIndex:e}),r&&r()}e||(window.removeEventListener("keydown",this.handleKeyDown),t&&setTimeout(()=>{this.setState({searchTerm:""})},300),i&&i())})}),Ji(this,"handleKeyDown",e=>{const{key:t}=e,{multi:n,searchable:r}=this.props,{searchTerm:i,inputFocused:o,localValues:a}=this.state;switch(t){case"Escape":return this.toggleOpen();case"ArrowDown":case"ArrowUp":e.preventDefault(),this.handleVerticalArrowsClick(t);break;case"Enter":const s=Tt(this.filteredOptions,this.state.currentHoveredOptionValue);s&&this.onSelect(s);break;case"Backspace":if(""===i&&r&&n&&o&&a.length){const e=[...a];e.pop(),this.applyChanges(e)}}}),Ji(this,"handleVerticalArrowsClick",e=>{const{currentHoveredOptionValue:t}=this.state,n=Ot(this.filteredOptions),r=n.findIndex(e=>e.value===t);"ArrowDown"===e?this.setNextOptionValue({allOptions:n,currentIndex:r}):this.setPrevOptionValue({allOptions:n,currentIndex:r})}),Ji(this,"setNextOptionValue",({allOptions:e,currentIndex:t})=>{t===e.length-1?this.setState({currentHoveredOptionValue:Object(ft.get)([0,"value"],e)||null,currentHoveredOptionIndex:0}):this.setState({currentHoveredOptionValue:Object(ft.get)([(t+1)%e.length,"value"],e),currentHoveredOptionIndex:t+1})}),Ji(this,"setPrevOptionValue",({allOptions:e,currentIndex:t})=>{t>0?this.setState({currentHoveredOptionValue:Object(ft.get)([t-1,"value"],e),currentHoveredOptionIndex:t-1}):this.setState({currentHoveredOptionValue:Object(ft.get)([e.length-1,"value"],e),currentHoveredOptionIndex:e.length-1})}),Ji(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.toggleOpen()}),Ji(this,"onSelect",e=>{const{multi:t}=this.props,{localValues:n}=this.state;let r=[];r=t?Object(ft.find)(t=>t.value===e.value,n)?n.filter(t=>t.value!==e.value):[...n,e]:[e];const i=Ot(this.filteredOptions).findIndex(t=>t.value===e.value);this.setState({currentHoveredOptionValue:e.value,currentHoveredOptionIndex:i}),this.applyChanges(r)}),Ji(this,"selectAll",()=>{const{options:e}=this.props,{localValues:t}=this.state;let n=[];(!t.length||t.length>Et(e))&&(n=Ot(e)),this.applyChanges(n)}),Ji(this,"onSearch",e=>this.setState({searchTerm:e.target.value,currentHoveredOptionValue:null,currentHoveredOptionIndex:0})),Ji(this,"debouncedOnChange",Object(ft.debounce)(this.props.debounce,e=>{const{onChange:t,options:n}=this.props;t(e,e.length===Et(n))})),Ji(this,"toggleFocus",()=>this.setState(e=>({inputFocused:!e.inputFocused})))}componentDidUpdate(e,t){this.state.localValues===t.localValues&&this.props.values!==e.values&&this.setState({localValues:this.props.values})}componentWillUnmount(){window.removeEventListener("keydown",this.handleKeyDown)}filterOptions(){const{options:e}=this.props;if(kt(e))return this.filterGroupedOptions();const{searchTerm:t}=this.state,{searchBy:n,sortable:r,sortDirection:i,sortBy:o}=this.props;return(r?Object(ft.orderBy)([o],[i],e):e).filter(e=>n.some(n=>this.checkString(t,e[n])))}applyChanges(e){const{closeOnSelect:t,multi:n}=this.props;this.setState({localValues:e},()=>{this.debouncedOnChange(e),!n&&t&&this.toggleOpen()})}render(){const{options:e,className:t,disabled:n,searchable:r,placeholder:i,headerRenderer:o,optionRenderer:s,optionLabelRenderer:l,multi:c,placeholderRenderer:u,menuRenderer:h,loading:d,maxItems:f,searchPlaceholder:p,error:m,small:g,large:v,inlineSearch:_,maxTags:y,onKeyDown:x,onKeyUp:b}=this.props,{open:w,searchTerm:C,localValues:S,currentHoveredOptionValue:k,currentHoveredOptionIndex:E}=this.state;return this.filteredOptions=this.filterOptions(),a.a.createElement(Pe,{onClick:this.handleClickOut,className:t},a.a.createElement(no,{disabled:n,className:t},!_&&a.a.createElement(Wt,{open:w,placeholder:i,values:S,options:e,headerRenderer:o,toggleOpen:this.toggleOpen,placeholderRenderer:u,loading:d,error:m,small:g,large:v}),_&&a.a.createElement(Bi,{values:S,open:w,placeholder:i,toggleOpen:this.toggleOpen,error:m,small:g,large:v,onSearch:this.onSearch,value:C,maxTags:y,onSelect:this.onSelect,loading:d,toggleFocus:this.toggleFocus,onKeyDown:x,onKeyUp:b}),a.a.createElement(eo.Provider,{value:E},a.a.createElement(Ni,{onKeyDown:x,onKeyUp:b,open:w,searchable:r,onSearch:this.onSearch,options:this.filteredOptions,total:Et(e),values:S,multi:c,selectAll:this.selectAll,optionRenderer:s,onSelect:this.onSelect,menuRenderer:h,searchTerm:C,maxItems:f,searchPlaceholder:p,optionLabelRenderer:l,small:g,large:v,inlineSearch:_,currentHoveredOptionValue:k,toggleFocus:this.toggleFocus}))))}}Ji(to,"propTypes",{className:X.a.string,options:Dt,values:Dt,onChange:X.a.func,onKeyDown:X.a.func,onKeyUp:X.a.func,placeholder:X.a.string,sortBy:X.a.string,sortable:X.a.bool,multi:X.a.bool,disabled:X.a.bool,searchable:X.a.bool,keepOpen:X.a.bool,searchBy:X.a.arrayOf(X.a.string),loading:X.a.bool,debounce:X.a.number,headerRenderer:X.a.func,optionRenderer:X.a.func,optionLabelRenderer:X.a.func,placeholderRenderer:X.a.func,menuRenderer:X.a.func,maxItems:X.a.number,closeOnSelect:X.a.bool,sortDirection:X.a.oneOf(["asc","desc"]),searchPlaceholder:X.a.string,error:X.a.bool,small:X.a.bool,large:X.a.bool,inlineSearch:X.a.bool,maxTags:X.a.number}),to.defaultProps={maxItems:5,sortable:!0,multi:!1,searchable:!1,sortBy:"label",searchBy:["label"],sortDirection:"asc",closeOnSelect:!0,debounce:0,maxTags:999};const no=l.a.div`
  position: relative;
...
`,Eo=l.a.div.attrs(({left:e})=>({style:{left:`${e}%`}}))`
  ...
  ${({visible:e})=>e&&s.css`
      opacity: 1;
    `};
`,Oo=({touched:e,selected:t,enabled:n,hovered:r,className:i})=>a.a.createElement(Ro,{touched:e,selected:t,enabled:n,className:i},a.a.createElement(Mo,{touched:e,selected:t,enabled:n,hovered:r}));var To=Oo;Oo.propTypes={className:X.a.string,touched:X.a.bool,selected:X.a.bool,enabled:X.a.bool,hovered:X.a.bool};const Ro=l.a.div`
  position: relative;
  width: 18px;
  height: 18px;
  border-radius: 50%;
...
`,zc=l.a.text`
  ...
  alignment-baseline: middle;
`;function Ic(){return(Ic=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const $c=l.a.line`
