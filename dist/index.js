...
`;function Ta(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Ra="YYYY-MM-DD",ja=["SU","MO","TU","WE","TH","FR","SA"];class Sa extends i.Component{constructor(...e){super(...e),Ta(this,"state",{today:ma()(),offset:0,open:!1,selection:this.props.initialSelection,committedSelection:this.props.initialSelection,tmpStart:null,selecting:!1,hoveredDate:null,selectedPreset:[]}),Ta(this,"datesRenderer",(e=0)=>{const{offset:t,today:n,selection:r,selecting:a,hoveredDate:i}=this.state,s=[],l=n.clone().startOf("month"),c=l.add(e+t,"month"),u=c.daysInMonth(),p=c.format("MMMM YYYY");for(let f=0;f<ja.length;f++)s.push(o.a.createElement(Na,{key:`date-${ja[f]}-${f}`,type:"title"},o.a.createElement(Ia,{type:"title"},ja[f])));for(let f=l.day();f>0;f--)s.push(o.a.createElement(Na,{key:`date-placeholder-${f}`,disabled:!0}));for(let f=1;f<=u;f++){const e=c.clone().set("date",f);let t=e.isBetween(r[0],r[1],null,"[]");a&&e.isBetween(r[0],i,null,"[]")&&(t=!0);const l=e.format(Ra)===r[0],u=e.format(Ra)===r[1];s.push(o.a.createElement(Na,{key:`date-${f}`,onClick:()=>this.handleClick(e.format(Ra)),onMouseEnter:()=>this.setHover(e.format(Ra)),selected:t,sameDay:r[0]===r[1]||!r[1],isStart:l,isEnd:u},o.a.createElement(Ia,{today:e.format(Ra)===n.format(Ra),type:l||u?"edge":"normal"},f)))}return o.a.createElement(Fa,{key:`month-${e}`},o.a.createElement(za,{onClick:this.selectMonth([n.clone().add(e+t,"month").startOf("month").format(Ra),n.clone().add(e+t,"month").endOf("month").format(Ra)])},p),s)}),Ta(this,"setHover",(e=null)=>{const{selecting:t,tmpStart:n}=this.state;let r={};t&&(r=ma()(e).isBefore(n)?{selection:[e,n]}:{selection:[n,e]}),this.setState(function(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},r=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),r.forEach(function(t){Ta(e,t,n[t])})}return e}({hoveredDate:e},r))}),Ta(this,"toggleOpen",()=>this.setState(e=>({open:!e.open}),()=>{this.state.open?this.setOffset():setTimeout(()=>{this.setState({offset:0,selecting:!1,hoveredDate:null})},300)})),Ta(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.cancel()}),Ta(this,"setOffset",()=>{const{today:e,selection:t}=this.state;if(t[0]){let n=ma()(t[0]).startOf("month").diff(e.clone().startOf("month"),"months");this.setState({offset:n})}}),Ta(this,"next",()=>this.setState(e=>({offset:e.offset+1}))),Ta(this,"prev",()=>this.setState(e=>({offset:e.offset-1}))),Ta(this,"apply",()=>this.setState({committedSelection:this.state.selection},()=>{this.toggleOpen(),this.props.onChange(this.state.committedSelection)})),Ta(this,"cancel",()=>{this.setState({open:!1,selecting:!1},()=>{setTimeout(()=>{this.setState({selection:this.state.committedSelection})},300)})}),Ta(this,"handleClick",e=>{const{selecting:t,tmpStart:n}=this.state;if(t){if(ma()(e).isBefore(n))return void this.setState({selecting:!1,selection:[e,n],tmpStart:null});this.setState({selecting:!1,selection:[n,e],tmpStart:null})}else this.setState({selecting:!0,selection:[e,null],tmpStart:e,selectedPreset:[]})}),Ta(this,"selectMonth",e=>()=>this.setState({selection:e,selecting:!1})),Ta(this,"setPreset",e=>{this.setState({selection:e[0].selection,selectedPreset:e},()=>{this.setOffset(),this.props.onChange(e[0].selection)})})}render(){const{open:e,committedSelection:t,selectedPreset:n}=this.state,{className:r,months:a,firstDayOfWeek:i}=this.props,s=[];for(let o=0;o<a;o++)s.push(this.datesRenderer(o));return o.a.createElement(ze,{onClick:this.handleClickOut},o.a.createElement(xa,{onClick:this.toggleOpen,selection:t,open:e}),o.a.createElement(Ma,{visible:e,className:r,total:a},o.a.createElement(Ca,{onChange:this.setPreset,selectedPreset:n,firstDayOfWeek:i}),o.a.createElement(Ba,{margin:"0"}),o.a.createElement(Da,null,o.a.createElement(Ua,{onClick:this.prev},o.a.createElement(qa,{rotation:"-180deg"})),o.a.createElement(Ua,{onClick:this.next},o.a.createElement(qa,{rotation:"0deg"}))),o.a.createElement(Wa,null,s),o.a.createElement(Ba,null),o.a.createElement(Pa,null,o.a.createElement(Ya,{onClick:this.cancel},"Cancel"),o.a.createElement(Ya,{primary:!0,onClick:this.apply},"Apply"))))}}Ta(Sa,"propTypes",{onChange:G.a.func,className:G.a.string,months:G.a.number,initialSelection:G.a.arrayOf(G.a.string),firstDayOfWeek:G.a.number}),Ta(Sa,"defaultProps",{months:1,onChange:()=>{},initialSelection:[],firstDayOfWeek:0});var La=Sa;const Ma=l.a.div`
  user-select: none;
