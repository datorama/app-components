...
import { fill, size, isNil, noop } from 'lodash/fp';

import { MAIN_COLORS } from './tornado.constants';

import TornadoChart from './TornadoChart';

class TornadoComp extends React.Component {
  static propTypes = {
    ...
    topLabelRenderer: PropTypes.func,
    bottomStatsRenderer: PropTypes.func,
  };
  ...
  topStrip() {
    const { data, topLabelRenderer = noop, theme } = this.props;
  ...
  bottomStrip() {
    const { data, theme, bottomStatsRenderer = noop } = this.props;
    const { selectedIndex } = this.state;
...
export const Tornado = withTheme(TornadoComp);
