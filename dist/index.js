...
`,Bn=l.a.div.attrs(({left:e})=>({style:{left:`${e}%`}}))`
  ...
  ${({visible:e})=>e&&s.css`
      ...
      opacity: 1;
    `};
`,Yn=({touched:e,selected:t,enabled:n,hovered:r,className:a})=>o.a.createElement(qn,{touched:e,selected:t,enabled:n,className:a},o.a.createElement(Hn,{touched:e,selected:t,enabled:n,hovered:r}));var Un=Yn;Yn.propTypes={className:X.a.string,touched:X.a.bool,selected:X.a.bool,enabled:X.a.bool,hovered:X.a.bool};const qn=l.a.div`
  position: relative;
  width: 18px;
  height: 18px;
  border-radius: 50%;
...
`;function Pa(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}class Ba extends o.a.Component{constructor(...e){super(...e),Pa(this,"state",{editMode:!1,value:this.props.initialValue}),Pa(this,"onChange",e=>{this.setState({editMode:!0,value:e.target.value}),this.props.onChange(e.target.value)}),Pa(this,"onBlur",()=>{this.setState({editMode:!1})})}render(){const{date:e,onClick:t,dateFormat:n}=this.props,r=!this.state.editMode&&e?Sa()(e).format(n):this.state.value;return o.a.createElement(Ya,{onChange:this.onChange,onBlur:this.onBlur,onClick:t,value:r})}}Pa(Ba,"propTypes",{date:K.string,initialValue:K.string,onChange:K.func.isRequired,onClick:K.func});const Ya=l.a.input`
  ...
  color: ${({theme:e})=>e.p600};
  text-align: center;
`;var Ua=Ba;function qa(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Ha="YYYY-MM-DD",Va=["SU","MO","TU","WE","TH","FR","SA"];class Za extends i.Component{constructor(...e){super(...e),qa(this,"state",{today:Sa()(),offset:0,open:!1,selection:this.props.initialSelection,committedSelection:this.props.initialSelection,selecting:!1,selectedPreset:[],tmpStart:"",hoveredDate:""}),qa(this,"datesRenderer",(e=0)=>{const{offset:t,today:n,selection:r,selecting:a,hoveredDate:i}=this.state,s=[],l=n.clone().startOf("month"),c=l.add(e+t,"month"),u=c.daysInMonth(),p=c.format("MMMM YYYY");for(let f=0;f<Va.length;f++)s.push(o.a.createElement(ri,{key:`date-${Va[f]}-${f}`,type:"title"},o.a.createElement(ai,{type:"title"},Va[f])));for(let f=l.day();f>0;f--)s.push(o.a.createElement(ri,{key:`date-placeholder-${f}`,disabled:!0}));for(let f=1;f<=u;f++){const e=c.clone().set("date",f);let t=e.isBetween(r[0],r[1],void 0,"[]");a&&e.isBetween(r[0],i,void 0,"[]")&&(t=!0);const l=e.format(Ha)===r[0],u=e.format(Ha)===r[1];s.push(o.a.createElement(ri,{key:`date-${f}`,onClick:()=>this.handleClick(e.format(Ha)),onMouseEnter:()=>this.setHover(e.format(Ha)),selected:t,sameDay:r[0]===r[1]||!r[1],isStart:l,isEnd:u},o.a.createElement(ai,{today:e.format(Ha)===n.format(Ha),type:l||u?"edge":"normal"},f)))}return o.a.createElement(ni,{key:`month-${e}`},o.a.createElement(ti,{onClick:this.selectMonth([n.clone().add(e+t,"month").startOf("month").format(Ha),n.clone().add(e+t,"month").endOf("month").format(Ha)])},p),s)}),qa(this,"setHover",(e="")=>{const{selecting:t,tmpStart:n}=this.state;let r={};t&&(r=Sa()(e).isBefore(n)?{selection:[e,n]}:{selection:[n,e]}),this.setState(function(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{},r=Object.keys(n);"function"===typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(n).filter(function(e){return Object.getOwnPropertyDescriptor(n,e).enumerable}))),r.forEach(function(t){qa(e,t,n[t])})}return e}({hoveredDate:e},r))}),qa(this,"toggleOpen",()=>this.setState(e=>({open:!e.open}),()=>{this.state.open?this.setOffset():setTimeout(()=>{this.setState({selecting:!1,hoveredDate:""})},300)})),qa(this,"openPopup",()=>{this.setOffset(),this.setState({open:!0})}),qa(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.cancel()}),qa(this,"setOffset",()=>{const{today:e,selection:t}=this.state;if(t[0]){let n=Sa()(t[0]).startOf("month").diff(e.clone().startOf("month"),"months");this.setState({offset:n})}}),qa(this,"next",()=>this.setState(e=>({offset:e.offset+1}))),qa(this,"prev",()=>this.setState(e=>({offset:e.offset-1}))),qa(this,"apply",()=>this.setState({committedSelection:this.state.selection},()=>{this.toggleOpen(),this.props.onChange(this.state.committedSelection)})),qa(this,"cancel",()=>{this.setState({open:!1,selecting:!1},()=>{setTimeout(()=>{this.setState({selection:this.state.committedSelection})},300)})}),qa(this,"handleClick",e=>{const{selecting:t,tmpStart:n}=this.state;if(t){if(Sa()(e).isBefore(n))return void this.setState({selecting:!1,selection:[e,n],tmpStart:""});this.setState({selecting:!1,selection:[n,e],tmpStart:""})}else this.setState({selecting:!0,selection:[e,""],tmpStart:e,selectedPreset:[]})}),qa(this,"selectMonth",e=>()=>this.setState({selection:e,selecting:!1})),qa(this,"setPreset",e=>{this.setState({selection:e[0].selection,selectedPreset:e},()=>{this.setOffset(),this.props.onChange(e[0].selection)})}),qa(this,"onChangeDate",(e,t)=>{const{dateFormat:n}=this.props;Sa()(t,n).isValid()&&this.setState(r=>{const{selection:a}=r;return{selection:Object(pt.set)([e],Sa()(t,n).format(Ha),a)}})})}render(){const{open:e,committedSelection:t,selectedPreset:n}=this.state,{className:r,months:a,firstDayOfWeek:i,dateFormat:s}=this.props,l=[],[c,u]=t;for(let o=0;o<a;o++)l.push(this.datesRenderer(o));return o.a.createElement(De,{onClick:this.handleClickOut},o.a.createElement(Ka,null,o.a.createElement(Xa,{onClick:this.toggleOpen}),o.a.createElement(Ua,{date:c,dateFormat:s,initialValue:"start date",onClick:this.openPopup,onChange:e=>this.onChangeDate(0,e)}),o.a.createElement(Ga,null,"-"),o.a.createElement(Ua,{date:u,dateFormat:s,initialValue:"end date",onClick:this.openPopup,onChange:e=>this.onChangeDate(1,e)}),o.a.createElement(Qa,{rotation:e?"180deg":"0deg",onClick:this.toggleOpen})),o.a.createElement(Ja,{visible:e,className:r,total:a},o.a.createElement(za,{onChange:this.setPreset,selectedPreset:n,firstDayOfWeek:i}),o.a.createElement(oi,{margin:"0"}),o.a.createElement(ei,null,o.a.createElement(ci,{onClick:this.prev},o.a.createElement(ui,{rotation:"-180deg"})),o.a.createElement(ci,{onClick:this.next},o.a.createElement(ui,{rotation:"0deg"}))),o.a.createElement(ii,null,l),o.a.createElement(oi,null),o.a.createElement(si,null,o.a.createElement(li,{onClick:this.cancel},"Cancel"),o.a.createElement(li,{primary:!0,onClick:this.apply},"Apply"))))}}qa(Za,"propTypes",{onChange:X.a.func,className:X.a.string,months:X.a.number,initialSelection:X.a.arrayOf(X.a.string),firstDayOfWeek:X.a.number,dateFormat:X.a.string}),qa(Za,"defaultProps",{months:1,initialSelection:[],firstDayOfWeek:0,dateFormat:Ha,onChange:()=>{}});const Ka=l.a.div`
  min-width: 210px;
  padding: 4px 8px;
  box-sizing: border-box;
  border-radius: 4px;
