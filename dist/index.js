...
`,kt=e=>Object(ft.get)([0,"options"],e),Et=e=>kt(e)?Object(ft.sumBy)(e=>Object(ft.size)(Object(ft.get)("options",e)),e):Object(ft.size)(e),Ot=e=>kt(e)?Object(ft.flatMap)("options",e):[...e],Tt=(e,t)=>Ot(e).find(e=>e.value===t),Rt=l.a.div`
  width: 100%;
...
`,zt=l()(Mt)`
  ...
  pointer-events: none;
`,It=e=>a.a.createElement(Lt,{className:e.className},a.a.createElement(jt,{delay:"0"}),a.a.createElement(jt,{delay:"500ms"}),a.a.createElement(jt,{delay:"1000ms"}));var $t=It;It.propTypes={className:X.a.string};const Lt=l.a.div`
  display: flex;
  align-items: center;
`,jt=l.a.div`
  width: 4px;
...
`,Yi=l()($t)`
  margin-right: 8px;
`;function Ki(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Xi=a.a.createContext(null);class Qi extends a.a.Component{constructor(...e){super(...e),Ki(this,"state",{open:!1,searchTerm:"",localValues:this.props.values,currentHoveredOptionValue:null,currentHoveredOptionIndex:0,inputFocused:!1}),Ki(this,"filteredOptions",[]),Ki(this,"checkString",(e,t)=>t.toString().toLowerCase().includes(e.toLowerCase())),Ki(this,"filterGroupedOptions",()=>{const{searchTerm:e}=this.state,{searchBy:t,options:n,sortable:r,sortDirection:i,sortBy:o}=this.props,a=Object(ft.map)(n=>{const r=n.options.filter(n=>t.some(t=>this.checkString(e,n[t])));return Object(ft.set)("options",r,n)},n);return r?this.sortGroupedOptions(a,o,i):a}),Ki(this,"sortGroupedOptions",(e,t,n)=>Object(ft.map)(e=>{const r=Object(ft.orderBy)([t],[n],e.options);return Object(ft.set)("options",r,e)},e)),Ki(this,"toggleOpen",()=>{const{keepOpen:e,inlineSearch:t}=this.props,{open:n}=this.state;e&&n||this.setState(e=>({open:!e.open,searchTerm:e.open?e.searchTerm:""}),()=>{const{open:e,currentHoveredOptionValue:n}=this.state,{onOpen:r,onClose:i}=this.props;if(e){window.addEventListener("keydown",this.handleKeyDown);const e=Ot(this.filteredOptions).findIndex(e=>e.value===n);this.setState({currentHoveredOptionIndex:e}),r&&r()}e||(window.removeEventListener("keydown",this.handleKeyDown),t&&setTimeout(()=>{this.setState({searchTerm:""})},300),i&&i())})}),Ki(this,"handleKeyDown",e=>{const{key:t}=e,{multi:n,searchable:r}=this.props,{searchTerm:i,inputFocused:o,localValues:a}=this.state;switch(t){case"Escape":return this.toggleOpen();case"ArrowDown":case"ArrowUp":e.preventDefault(),this.handleVerticalArrowsClick(t);break;case"Enter":const s=Tt(this.filteredOptions,this.state.currentHoveredOptionValue);s&&this.onSelect(s);break;case"Backspace":if(""===i&&r&&n&&o&&a.length){const e=[...a];e.pop(),this.applyChanges(e)}}}),Ki(this,"handleVerticalArrowsClick",e=>{const{currentHoveredOptionValue:t}=this.state,n=Ot(this.filteredOptions),r=n.findIndex(e=>e.value===t);"ArrowDown"===e?this.setNextOptionValue({allOptions:n,currentIndex:r}):this.setPrevOptionValue({allOptions:n,currentIndex:r})}),Ki(this,"setNextOptionValue",({allOptions:e,currentIndex:t})=>{t===e.length-1?this.setState({currentHoveredOptionValue:Object(ft.get)([0,"value"],e)||null,currentHoveredOptionIndex:0}):this.setState({currentHoveredOptionValue:Object(ft.get)([(t+1)%e.length,"value"],e),currentHoveredOptionIndex:t+1})}),Ki(this,"setPrevOptionValue",({allOptions:e,currentIndex:t})=>{t>0?this.setState({currentHoveredOptionValue:Object(ft.get)([t-1,"value"],e),currentHoveredOptionIndex:t-1}):this.setState({currentHoveredOptionValue:Object(ft.get)([e.length-1,"value"],e),currentHoveredOptionIndex:e.length-1})}),Ki(this,"handleClickOut",()=>{const{open:e}=this.state;e&&this.toggleOpen()}),Ki(this,"onSelect",e=>{const{multi:t}=this.props,{localValues:n}=this.state;let r=[];r=t?Object(ft.find)(t=>t.value===e.value,n)?n.filter(t=>t.value!==e.value):[...n,e]:[e];const i=Ot(this.filteredOptions).findIndex(t=>t.value===e.value);this.setState({currentHoveredOptionValue:e.value,currentHoveredOptionIndex:i,searchTerm:""}),this.applyChanges(r)}),Ki(this,"selectAll",()=>{const{options:e}=this.props,{localValues:t}=this.state;let n=[];(!t.length||t.length>Et(e))&&(n=Ot(e)),this.applyChanges(n)}),Ki(this,"onSearch",e=>this.setState({searchTerm:e.target.value,currentHoveredOptionValue:null,currentHoveredOptionIndex:0})),Ki(this,"debouncedOnChange",Object(ft.debounce)(this.props.debounce,e=>{const{onChange:t,options:n}=this.props;t(e,e.length===Et(n))})),Ki(this,"toggleFocus",()=>this.setState(e=>({inputFocused:!e.inputFocused})))}componentDidUpdate(e,t){this.state.localValues===t.localValues&&this.props.values!==e.values&&this.setState({localValues:this.props.values})}componentWillUnmount(){window.removeEventListener("keydown",this.handleKeyDown)}filterOptions(){const{options:e}=this.props;if(kt(e))return this.filterGroupedOptions();const{searchTerm:t}=this.state,{searchBy:n,sortable:r,sortDirection:i,sortBy:o}=this.props;return(r?Object(ft.orderBy)([o],[i],e):e).filter(e=>n.some(n=>this.checkString(t,e[n])))}applyChanges(e){const{closeOnSelect:t,multi:n}=this.props;this.setState({localValues:e},()=>{this.debouncedOnChange(e),!n&&t&&this.toggleOpen()})}render(){const{options:e,className:t,disabled:n,searchable:r,placeholder:i,headerRenderer:o,optionRenderer:s,optionLabelRenderer:l,multi:c,placeholderRenderer:u,menuRenderer:h,loading:d,maxItems:f,searchPlaceholder:p,error:m,small:g,large:v,inlineSearch:_,maxTags:y}=this.props,{open:x,searchTerm:b,localValues:w,currentHoveredOptionValue:C,currentHoveredOptionIndex:S}=this.state;return this.filteredOptions=this.filterOptions(),a.a.createElement(Pe,{onClick:this.handleClickOut,className:t},a.a.createElement(Ji,{disabled:n,className:t},!_&&a.a.createElement(Wt,{open:x,placeholder:i,values:w,options:e,headerRenderer:o,toggleOpen:this.toggleOpen,placeholderRenderer:u,loading:d,error:m,small:g,large:v}),_&&a.a.createElement(Fi,{values:w,open:x,placeholder:i,toggleOpen:this.toggleOpen,error:m,small:g,large:v,onSearch:this.onSearch,value:b,maxTags:y,onSelect:this.onSelect,loading:d,toggleFocus:this.toggleFocus}),a.a.createElement(Xi.Provider,{value:S},a.a.createElement(Pi,{open:x,searchable:r,onSearch:this.onSearch,options:this.filteredOptions,total:Et(e),values:w,multi:c,selectAll:this.selectAll,optionRenderer:s,onSelect:this.onSelect,menuRenderer:h,searchTerm:b,maxItems:f,searchPlaceholder:p,optionLabelRenderer:l,small:g,large:v,inlineSearch:_,currentHoveredOptionValue:C,toggleFocus:this.toggleFocus}))))}}Ki(Qi,"propTypes",{className:X.a.string,options:Dt,values:Dt,onChange:X.a.func,placeholder:X.a.string,sortBy:X.a.string,sortable:X.a.bool,multi:X.a.bool,disabled:X.a.bool,searchable:X.a.bool,keepOpen:X.a.bool,searchBy:X.a.arrayOf(X.a.string),loading:X.a.bool,debounce:X.a.number,headerRenderer:X.a.func,optionRenderer:X.a.func,optionLabelRenderer:X.a.func,placeholderRenderer:X.a.func,menuRenderer:X.a.func,maxItems:X.a.number,closeOnSelect:X.a.bool,sortDirection:X.a.oneOf(["asc","desc"]),searchPlaceholder:X.a.string,error:X.a.bool,small:X.a.bool,large:X.a.bool,inlineSearch:X.a.bool,maxTags:X.a.number}),Qi.defaultProps={maxItems:5,sortable:!0,multi:!1,searchable:!1,sortBy:"label",searchBy:["label"],sortDirection:"asc",closeOnSelect:!0,debounce:0,maxTags:999};const Ji=l.a.div`
  position: relative;
